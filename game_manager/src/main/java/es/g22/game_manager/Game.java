...
public class Game {
    ...
    public boolean checkWinner(){
        for (int r = 0; r < 3; r++) {
            if (this.board[r][0].equals(this.board[r][1]) && this.board[r][1].equals(this.board[r][2]) && !this.board[r][0].equals("")){
                this.finished = true;
                if(this.board[r][0] == "1"){
        ...
        for (int c = 0; c < 3; c++) {
            if (this.board[0][c].equals(this.board[1][c]) && this.board[1][c].equals(this.board[2][c]) && !this.board[1][c].equals("")) {
                this.finished = true;
        ...
        if (this.board[0][0].equals(this.board[1][1]) && this.board[1][1].equals(this.board[2][2]) && !this.board[1][1].equals("")){
            this.finished = true;
        ...
        if (this.board[0][2].equals(this.board[1][1]) && this.board[1][1].equals(this.board[2][0]) && !this.board[1][1].equals("")){
            this.finished = true;
            if(this.board[1][1].equals("1")){
                this.player1Winner = true;
            }
